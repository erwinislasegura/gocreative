...
----------
- PHP 8.0 o superior.
- Apache/LiteSpeed con soporte para .htaccess.
...
5. Confirma que index.php y .htaccess queden en la raíz pública, no dentro de otra subcarpeta.
6. Selecciona PHP 8.0, 8.1, 8.2 o superior en MultiPHP Manager.
7. Prueba la portada, todas las páginas y el formulario de contacto.
...
3. Configura Google Analytics o Tag Manager si se utilizará medición.
4. Prueba el envío desde /contacto/ y confirma que llegue al correo.
5. Vacía caché de LiteSpeed/cPanel si todavía aparece la versión anterior.
