...
catch(Throwable $exception){error_log('Error enviando cotización: '.$exception->getMessage());flash('danger','El servidor no pudo enviar el correo. Revisa la configuración de mail() e inténtalo nuevamente.');}
